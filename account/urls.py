...
urlpatterns = [
    ...
    path('users/follow/', views.user_follow, name='user_follow'), #this shd be above detail route
# use the user_detail URL pattern to generate the canonical URL for users.
